                                ...
                                FirebaseDatabase.getInstance().getReference("CustomerOrdersHistory").child(userid).child(randomuid).child("OtherInformation").child("Status").setValue("Giao hàng thành công").addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        FirebaseDatabase.getInstance().getReference("ChefOrdersHistory").child(Chefid).child(randomuid).child("OtherInformation").child("ShippingDate").setValue(formattedDateTime).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
                                                FirebaseDatabase.getInstance().getReference("ChefOrdersHistory").child(Chefid).child(randomuid).child("OtherInformation").child("OrderStatus").setValue("Giao hàng thành công").addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    @Override
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        FirebaseDatabase.getInstance().getReference("CustomerOrdersHistory").child(userid).child(randomuid).child("OtherInformation").child("OrderStatus").setValue("Giao hàng thành công").addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            @Override
                                                            public void onComplete(@NonNull Task<Void> task) {
