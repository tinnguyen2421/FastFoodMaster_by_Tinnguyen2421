...
public class DeliveryShipOrders {
    ...
    public DeliveryShipOrders(String chefId, String dishId, String dishName, String dishPrice, String dishQuantity, String randomUID, String totalPrice, String userId,String imageURL) {
        ChefID = chefId;
        DishID = dishId;
        DishName = dishName;
        DishPrice = dishPrice;
