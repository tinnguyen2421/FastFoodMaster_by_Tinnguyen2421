...
public class ChefWaitingOrders1 {
    ...
    public ChefWaitingOrders1(String address, String grandTotalPrice, String mobileNumber, String name, String note, String randomUID, String status, String date, String aceptDate) {
        Address = address;
